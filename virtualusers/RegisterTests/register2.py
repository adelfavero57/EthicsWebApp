...
# Test to see if first name 150 char restraint works as intended
...
time.sleep(3)
driver.find_element_by_name("first_name").send_keys(
    "svgsgassabvasfdbsadbsfabfdsabdfabafsdbdfsabdfabsakjlvabskljbvasjbvnsaljcbdaildsuyvgsihavbcsdlaijvbsdalvskajvbaskvjbdsavkaslbdvkasvlsdvbakjdbsvadsjvbasidjhsabdflasdbfsabf")
time.sleep(3)
