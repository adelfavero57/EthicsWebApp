...
# Test to see if password char restraint works as intended
...
time.sleep(3)
driver.find_element_by_name("password1").send_keys("usyd")
time.sleep(3)
driver.find_element_by_name("password2").send_keys("usyd")
time.sleep(3)
