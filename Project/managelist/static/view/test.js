...
$(".think_aloud").on('click', function(){
    ...
    let text_obj = $(this).siblings(".think_aloud_txt");
    let status = text_obj.data("status");


    if (status == "hidden"){
        text_obj.data("status", "show");
        $(this).siblings(".source_txt").data("status", "hidden");
        $(this).siblings(".source_txt").hide();
        $(this).siblings(".lab_study_txt").data("status", "hidden");
        $(this).siblings(".lab_study_txt").hide();
        text_obj.show();
    }else{
        text_obj.data("status", "hidden");
        text_obj.hide();
    };  
...
$(".crowed_source").on('click', function(){
    ...
    let text_obj = $(this).siblings(".source_txt");
    let status = text_obj.data("status");


    if (status == "hidden"){
        text_obj.data("status", "show");
        $(this).siblings(".think_aloud_txt").data("status", "hidden");
        $(this).siblings(".think_aloud_txt").hide();
        $(this).siblings(".lab_study_txt").data("status", "hidden");
        $(this).siblings(".lab_study_txt").hide();
        text_obj.show();
    }else{
...
$(".lab_study").on('click', function(){
    ...
    let text_obj = $(this).siblings(".lab_study_txt");
    let status = text_obj.data("status");
...
$(".think_aloud_p").on('click', function(){
    ...
    text_area.val(text_area.val() + text);
